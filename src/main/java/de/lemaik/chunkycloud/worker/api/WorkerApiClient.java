...
public class WorkerApiClient {
    ...
    public CompletableFuture<FinishMergeTaskResponse> getMergeTaskUploadUrls(int jobId) {
        ...
        client.newCall(new Request.Builder()
                        .url(baseUrl + "/worker-nodes/me/tasks/merge/" + jobId + "/upload").post(RequestBody.create(null, new byte[0]))
                        .build())
                .enqueue(new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
    ...
    public CompletableFuture<Void> finishMergeTask(int jobId) {
        ...
        client.newCall(new Request.Builder()
                        .url(baseUrl + "/worker-nodes/me/tasks/merge/" + jobId + "/finish").post(RequestBody.create(null, new byte[0]))
                        .build())
                .enqueue(new Callback() {
                    @Override
                    public void onFailure(Call call, IOException e) {
